  ...
  <div class="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 p-6">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="text-center mb-12">
        <div class="inline-flex items-center justify-center p-4 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl mb-6 shadow-lg">
          <span class="text-4xl text-white">🌱</span>
        </div>
        <h1 class="text-4xl font-bold text-gray-800 mb-3">Smart Agriculture Dashboard</h1>
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">
          Real-time monitoring and control system for precision farming operations
        </p>
      </div>
          ...
          <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
            ...
            <div class="flex space-x-4">
              <button
                ...
                :disabled="isLoading"
                class="flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-4 py-2 rounded-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                :disabled="isLoading"
                class="flex-1 bg-gradient-to-r from-red-500 to-rose-600 text-white px-4 py-2 rounded-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <span class="flex items-center justify-center">
                  <span class="mr-2">🔴</span>
                  Turn Off
